...
public class NodoMetodo extends Nodo{
    ...
    public NodoMetodo(int tipoOp , Nodo nodoIz, Nodo nodoDr, Posicion pos) {
        this.tipoOp = tipoOp;
        this.nodoIz = nodoIz;
        this.nodoDr = nodoDr;
        this.pos = pos;
    ...
    public NodoMetodo(Simbolo simbolo, int tipoOp, int ambito, Nodo nodoIz, Nodo nodoDr, ArrayList<Simbolo> listaParams, ArrayList<Nodo> listaAcciones, Posicion pos) {
