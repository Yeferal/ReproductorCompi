...
public class NodoAsignacion extends Nodo{
    /**
     *  1. Nodo asignacion var (var = <dato>)
     *  1.1 Nodo asignacion var (var = var + <dato>)
     *  1.2 Nodo asignacion var (var = var + 1)
     *  1.3 Nodo asignacion var (var = var - 1)
     *  2. Nodo asignacion var arreglo
     *  0. Simbolo
     **/
    ...
    public NodoAsignacion(int tipoOp , Nodo nodoIz, Nodo nodoDr, Posicion pos) {
        this.tipoOp = tipoOp;
        this.nodoIz = nodoIz;
        this.nodoDr = nodoDr;
        this.pos = pos;
    ...
    public NodoAsignacion(int tipoOp, int ambito, Nodo nodoIz, Nodo nodoDr, ArrayList<Integer> dimens, ArrayList<Object> lista) {
        this.tipoOp = tipoOp;
        this.ambito = ambito;
        this.nodoIz = nodoIz;
        this.nodoDr = nodoDr;
